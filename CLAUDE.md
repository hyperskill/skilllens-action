...
- Inputs: `skilllens-api-url` (required), `oidc-audience`, `default-language`, `max-topics`, `min-confidence`, `comment-marker`, `fail-on-proxy-error`
- Outputs: `topics-json`, `comment-url`
- Runtime: `node20` executing `dist/index.js`
